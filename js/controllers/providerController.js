angular.module('providerController', ['store-factories']);

function ProviderListController($scope, rest, $window, usSpinnerService, modelFactory) {
  usSpinnerService.spin('spinner');
  $scope.module = 'providers';
  $scope.paginate = {
    page: 1,
    skip: 0,
    limit: 15,
...
function ProviderViewController($scope, $routeParams, rest, $location, $sce, usSpinnerService, $rootScope, $anchorScroll) {
  usSpinnerService.spin('spinner');
  $scope.module = 'providers';
...
function ProviderCreateController($scope, rest, $location, $rootScope, usSpinnerService) {
  $scope.module = 'providers';
  $scope.info = {};
  ...
  $scope.save = function() {
    ...
    var data = {
      ...
      cbuPeso: $scope.info.cbuPeso,
      cbuDolar: $scope.info.cbuDolar,
...
function ProviderEditController($scope, $routeParams, $location, rest, $rootScope, usSpinnerService) {
  usSpinnerService.spin('spinner');
  $scope.module = 'providers';
  $scope.info = {};
